...
namespace ContactApp.UnitTests
{
    internal class ContactTest
    {
        ...
        {
            DateTime birthday = new DateTime(2001, 8, 16);
            _contact = new Contact("Мишина", "Анастасия", "aa@mail.ru", "id654321", birthday, new PhoneNumber(78005553535));
        }
